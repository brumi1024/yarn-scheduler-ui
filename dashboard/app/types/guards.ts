...
export function isCapacitySchedulerInfo(obj: SchedulerInfo): obj is SchedulerInfo & { type: 'capacityScheduler' } {
...
export function isValidPropertyValue(value: string, descriptor: Pick<PropertyDescriptor, 'type' | 'validationRules' | 'enumValues'>): boolean {
