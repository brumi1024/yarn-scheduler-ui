    ...
    Dialog: ({ children, open, onOpenChange }: any) => {
        ...
        return (
            <div role="dialog" aria-modal="true">
                {children}
                <button onClick={() => onOpenChange(false)} aria-label="Close dialog">×</button>
            </div>
        );
    },
...
describe('AddLabelDialog', () => {
    ...
    describe('Dialog content', () => {
        it('should display title and description', () => {
            ...
            expect(screen.getByText('Add New Node Label')).toBeInTheDocument();
            expect(screen.getByText('Create a new node label for resource allocation')).toBeInTheDocument();
        });
        ...
        it('should display help text for label name', () => {
            ...
            expect(screen.getByText('Use letters, numbers, hyphens, and underscores only')).toBeInTheDocument();
        });
        ...
        it('should display exclusivity explanation', () => {
            ...
            expect(screen.getByText(/Only containers specifically requesting this label/)).toBeInTheDocument();
