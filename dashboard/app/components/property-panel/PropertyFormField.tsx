                ...
                return (
                    <FormItem className="flex flex-row items-center justify-between rounded-lg border p-3">
                        <div className="space-y-0.5 flex-1 min-w-0">
                            <FormLabel className={cn("flex items-center gap-1", !isFieldEnabled && "text-muted-foreground")}>
                                <span className="truncate">{property.displayName}{property.required ? ' *' : ''}</span>
                    ...
                    <div className="space-y-1">
                        ...
                        {(property.deprecated || property.deprecationMessage || !isFieldEnabled) && (
                            <div className="flex items-center flex-wrap gap-1 mt-2">
                                {property.deprecated && (
                                    <Badge variant="outline" className="text-xs h-5 border-orange-500 text-orange-500">
                                        Deprecated
                                    </Badge>
                                )}
