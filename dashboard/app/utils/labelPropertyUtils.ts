 ...
 */
export function generateLabelPropertyDescriptors(nodeLabels: NodeLabel[]): LabelPropertyDescriptor[] {
 ...
 */
export function groupLabelPropertiesByLabel(labelProperties: LabelPropertyDescriptor[]): Record<string, LabelPropertyDescriptor[]> {
    return labelProperties.reduce((groups, property) => {
