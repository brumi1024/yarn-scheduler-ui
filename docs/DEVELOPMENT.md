...
*   **`ValidationService.js`**:
    *   Provides *stateless* validation functions (e.g., queue name character checks, basic capacity string format checks). These can be used by Views for immediate feedback or by the Controller.
