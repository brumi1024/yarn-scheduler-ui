...
export class D3AnimationManager {
     ...
     */
    private applyNodeTransitions(transitions: NodeTransition[], progress: number): void {
     ...
     */
    private applyFlowTransitions(transitions: FlowTransition[], progress: number): void {
        transitions.forEach((transition) => {
     ...
     */
    createStaggeredAnimation(elements: LayoutNode[], staggerDelay: number = 50): Promise<void>[] {
