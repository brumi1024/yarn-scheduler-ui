...
export class SankeyFlowCalculator {
   ...
   */
  private calculateLevelFlows(
    sourceLevel: LayoutNode[],
    targetLevel: LayoutNode[]
  ): FlowPath[] {
    const flows: FlowPath[] = [];
