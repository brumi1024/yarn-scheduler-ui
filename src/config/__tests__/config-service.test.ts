...
describe('ConfigService', () => {
    ...
    describe('getPropertyDefinition', () => {
        ...
        it('finds queue property by full property key', () => {
            const property = configService.getPropertyDefinition('yarn.scheduler.capacity.Q_PATH_PLACEHOLDER.capacity');
    ...
    describe('extractQueuePath', () => {
        it('extracts queue path from property key', () => {
            const path = configService.extractQueuePath('yarn.scheduler.capacity.root.default.capacity');
        ...
        it('handles global properties without queue path', () => {
            const path = configService.extractQueuePath('yarn.scheduler.capacity.node-locality-delay');
    ...
    describe('isKnownPropertyName (private method testing via extractQueuePath)', () => {
        it('recognizes known property names', () => {
            ...
            const path1 = configService.extractQueuePath('yarn.scheduler.capacity.root.default.capacity');
            const path2 = configService.extractQueuePath('yarn.scheduler.capacity.root.test.maximum-capacity');
            const path3 = configService.extractQueuePath('yarn.scheduler.capacity.root.queue.ordering-policy');
