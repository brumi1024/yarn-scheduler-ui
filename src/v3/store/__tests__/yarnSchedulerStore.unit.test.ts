...
/**
 * Unit tests for YarnSchedulerStore.
 * These tests focus on simple, isolated behaviors of individual store methods.
 */
describe('YarnSchedulerStore - Unit Tests', () => {
    beforeEach(() => {
    ...
    describe('Reset and Revert', () => {
        it('should clear all property changes on revert', () => {
            const { result } = renderHook(() => useYarnSchedulerStore());
        ...
        it('should clear all node label changes on revert', () => {
            const { result } = renderHook(() => useYarnSchedulerStore());
        ...
        it('should reset entire store state', () => {
            ...
            act(() => {
                result.current.setOriginalConfig({ 'test.property': 'value' });
    ...
    describe('Simple Getters', () => {
        it('should find queue by path', () => {
            ...
            expect(queue?.config.capacity).toBe('100');
        });
