...
import { buildQueueTree, extractQueueConfig, flattenQueueTree, getQueuePrefix } from '../dataTransformers';
    ...
    describe('template property parsing', () => {
        ...
        it('should extract flexible auto-queue-creation-v2 template properties', () => {
            const fullConfig = {
                ...
                'yarn.scheduler.capacity.root.parent.auto-queue-creation-v2.leaf-template.accessible-node-labels':
                    'GPU',
                'yarn.scheduler.capacity.root.parent.auto-queue-creation-v2.leaf-template.accessible-node-labels.GPU.capacity':
                    '5w',
            };
    ...
    describe('node label based capacity parsing', () => {
        ...
        it('should extract template node label properties', () => {
            const fullConfig = {
                ...
                'yarn.scheduler.capacity.root.parent1.leaf-queue-template.accessible-node-labels.GPU.maximum-capacity':
                    '20',
