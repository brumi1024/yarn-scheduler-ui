...
import type { PropertyDescriptor, PropertyType, ValidationRule, PropertyCategory } from '../property-descriptor';
            ...
            validationRules: [
                {
                    ...
                    message: 'ACL must contain only alphanumeric characters, commas, hyphens, underscores, and asterisks',
                },
            ],
        };
...
describe('ValidationRule interface', () => {
    ...
    it('should handle pattern validation', () => {
        const patternRule: ValidationRule = {
            ...
            message: 'Must start with a letter and contain only alphanumeric characters, hyphens, and underscores',
        };
